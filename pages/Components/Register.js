...
export default function Register() {
     const [userInfo, setUserInfo] = useState({name: "", phoneNumber: "", company: "", loadNumber: "", customerName: "", containerNumber: ""});
          ...
          {isMobile && (
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
               ...
               {activeStep === 2 && isMobile &&(
                    <Grid container spacing={2}>
                         <Grid item xs={6}>
                              <Input disabled defaultValue={userInfo.name} inputProps={ariaLabel} />
                         </Grid>
                         <Grid item xs={6}>
                              <Input disabled defaultValue={userInfo.phoneNumber} inputProps={ariaLabel} />
                         </Grid>
                         <Grid item xs={6}>
                              <Input disabled defaultValue={userInfo.company} inputProps={ariaLabel} />
                         </Grid>
                         <Grid item xs={6}>
                         <Input disabled defaultValue={userInfo.loadNumber} inputProps={ariaLabel} />
                         </Grid>  
                         <Grid item xs={6}>
                              <Input disabled defaultValue={userInfo.customerName} inputProps={ariaLabel} />
                         </Grid>  
                         <Grid item xs={6}>
                              <Input disabled defaultValue={userInfo.containerNumber} inputProps={ariaLabel} />
                         </Grid>   
                    </Grid>
               )}
